...
const totalQuestions = 15; // Update this to the new total number of questions
let correctAnswers = 0;
let userAnswers = [];

// Countdown timer
const countdownElement = document.getElementById('countdown');
let countdownTime = 60 * 5; // 50 minutes in seconds
...
function showResult() {
    const resultText = `Usted ha contestado ${correctAnswers} de ${totalQuestions} preguntas correctas.`;
    let detailedResults = '';
    ...
    if (correctAnswers >= 10) { // Update this to the required number of correct answers
        document.getElementById('result').innerHTML = resultText + ' ¡Felicidades! ¡Usted ha aprobado esta práctica!<br>' + detailedResults;
    } else {
        document.getElementById('result').innerHTML = resultText + ' ¡Lo siento! Usted no ha pasado esta práctica<br>' + detailedResults;
    }
}
